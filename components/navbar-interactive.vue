  ...
  <div class="navbar-interactive-container">
    <header data-thq="thq-navbar" class="navbar-interactive-navbar-interactive">
      <div
        ...
        data-role="Nav"
        class="navbar-interactive-desktop-menu"
      >
        <nav
          data-thq="thq-navbar-nav-links"
          data-role="Nav"
          class="navbar-interactive-nav"
        >
          <nuxt-link to="/" class="navbar-interactive-navlink">
            {{ text }}
          </nuxt-link>
          <span class="navbar-interactive-text">{{ text1 }}</span>
          <span class="navbar-interactive-text1">{{ text2 }}</span>
          <span class="navbar-interactive-text2">{{ text3 }}</span>
          <span class="navbar-interactive-text3">{{ text4 }}</span>
        </nav>
      </div>
      <div
      ...
      <div data-thq="thq-mobile-menu" class="navbar-interactive-mobile-menu">
        <div
          ...
          data-role="Nav"
          class="navbar-interactive-nav1"
        >
          <div class="navbar-interactive-container1">
            <div
              data-thq="thq-close-menu"
              class="navbar-interactive-menu-close"
            ></div>
          </div>
          <nav
            data-thq="thq-mobile-menu-nav-links"
            data-role="Nav"
            class="navbar-interactive-nav2"
          >
            <span class="navbar-interactive-text4">{{ text5 }}</span>
            <span class="navbar-interactive-text5">{{ text6 }}</span>
            <span class="navbar-interactive-text6">{{ text7 }}</span>
            <span class="navbar-interactive-text7">{{ text8 }}</span>
            <span class="navbar-interactive-text8">{{ text9 }}</span>
          </nav>
          <div class="navbar-interactive-container2"></div>
        </div>
        <div class="navbar-interactive-icon-group">
          <svg
          ...
          ><svg
            ...
            class="navbar-interactive-icon6"
          >
            <path
