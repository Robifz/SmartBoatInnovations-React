            ...
            >
              ...
              >
                ...
                >
                  ...
                  <Link href="/about">
                    <a className="contact-link01">About</a>
                  </Link>
                  <Link href="/services">
                    <a className="contact-link02">Services</a>
                  </Link>
                  <Link href="/download-code">
                    <a className="contact-link03">Code</a>
                  </Link>
                  <Link href="/contact">
                    <a className="contact-link04">Contact</a>
                  </Link>
                </nav>
              </div>
              <div
              ...
              <div data-thq="thq-mobile-menu" className="contact-mobile-menu">
                ...
                >
                  ...
                  >
                    <Link href="/">
                      <a className="contact-link05">Home</a>
                    </Link>
                    <Link href="/about">
                      <a className="contact-link06">About</a>
                    </Link>
                    <Link href="/services">
                      <a className="contact-link07">Services</a>
                    </Link>
                    <Link href="/download-code">
                      <a className="contact-link08">Code</a>
                    </Link>
                    <Link href="/contact">
                      <a className="contact-link09">Contact</a>
                    </Link>
                  </nav>
        ...
        <footer className="contact-footer">
          <div className="contact-container6">
            <nav className="contact-nav3">
              <Link href="/">
                <a className="contact-link10">Home</a>
              </Link>
              <Link href="/about">
                <a className="contact-link11">About</a>
              </Link>
              <Link href="/services">
                <a className="contact-link12">Services</a>
              </Link>
              <Link href="/download-code">
                <a className="contact-link13">Code</a>
              </Link>
              <Link href="/contact">
                <a className="contact-link14">Contact</a>
              </Link>
            </nav>
          </div>
