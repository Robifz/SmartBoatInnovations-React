    ...
    <>
      <div className="download-code-container">
          ...
          <div className="download-code-container2">
            ...
            >
              <div
                ...
                data-role="Nav"
                className="download-code-desktop-menu"
              >
                <nav
                  data-thq="thq-navbar-nav-links"
                  data-role="Nav"
                  className="download-code-nav"
                >
                  <Link href="/">
                    <a className="download-code-link">Home</a>
                  </Link>
                  <span className="download-code-text">About</span>
                  <Link href="/services">
                    <a className="download-code-link01">Services</a>
                  </Link>
                  <Link href="/download-code">
                    <a className="download-code-link02">Code</a>
                  </Link>
                  <Link href="/contact">
                    <a className="download-code-link03">Contact</a>
                  </Link>
                </nav>
              </div>
              <div
                data-thq="thq-navbar-btn-group"
                className="download-code-btn-group"
              ></div>
              <div
                data-thq="thq-burger-menu"
                className="download-code-burger-menu"
              >
                <svg viewBox="0 0 1024 1024" className="download-code-icon">
                  <path d="M128 554.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 298.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 810.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"></path>
                </svg>
              </div>
              <div
                data-thq="thq-mobile-menu"
                className="download-code-mobile-menu"
              >
                <div
                ...
                >
                  ...
                  >
                    <Link href="/">
                      <a className="download-code-link04">Home</a>
                    </Link>
                    <Link href="/about">
                      <a className="download-code-link05">About</a>
                    </Link>
                    <Link href="/services">
                      <a className="download-code-link06">Services</a>
                    </Link>
                    <Link href="/download-code">
                      <a className="download-code-link07">Code</a>
                    </Link>
                    <Link href="/contact">
                      <a className="download-code-link08">Contact</a>
                    </Link>
                  </nav>
        ...
        <span className="download-code-text03">
          <span>
            ...
            crafted to enhance your smart boat&apos;s capabilities. I&apos;ve
            put in a lot of time and effort to develop this code, and if you
            find it valuable, I kindly ask for your support through a donation.
            <span
        ...
        <a
          ...
          className="download-code-link09"
        >
          <img
            alt="image"
        ...
        <footer className="download-code-footer">
          <div className="download-code-container6">
            <nav className="download-code-nav3">
              <Link href="/">
                <a className="download-code-link10">Home</a>
              </Link>
              <Link href="/about">
                <a className="download-code-link11">About</a>
              </Link>
              <Link href="/services">
                <a className="download-code-link12">Services</a>
              </Link>
              <Link href="/download-code">
                <a className="download-code-link13">Code</a>
              </Link>
              <Link href="/contact">
                <a className="download-code-link14">Contact</a>
              </Link>
            </nav>
          </div>
          ...
          <div className="download-code-container7">
            ...
            <div className="download-code-icon-group1">
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                className="download-code-link15"
              >
                <img
                  alt="image"
                  src="/kofi_logo_blue.svg"
      ...
      <style jsx>
        {`
          ...
          .download-code-link01 {
            font-style: normal;
            font-weight: 500;
            margin-left: 32px;
            text-decoration: none;
          }
          .download-code-link02 {
            font-style: normal;
            font-weight: 500;
            margin-left: 32px;
            text-decoration: none;
          }
          .download-code-link03 {
            font-style: normal;
            font-weight: 500;
            margin-left: 32px;
            text-decoration: none;
          ...
          .download-code-link04 {
            margin-bottom: var(--dl-space-space-unit);
            text-decoration: none;
          }
          .download-code-link05 {
            margin-bottom: var(--dl-space-space-unit);
            text-decoration: none;
          }
          .download-code-link06 {
            margin-bottom: var(--dl-space-space-unit);
            text-decoration: none;
          }
          .download-code-link07 {
            margin-bottom: var(--dl-space-space-unit);
            text-decoration: none;
          }
          .download-code-link08 {
            margin-bottom: var(--dl-space-space-unit);
            text-decoration: none;
          }
          ...
          .download-code-link10 {
            margin-left: 0px;
            text-decoration: underline;
          }
          .download-code-link11 {
            margin-left: var(--dl-space-space-unit);
            text-decoration: underline;
          }
          .download-code-link12 {
            margin-left: var(--dl-space-space-unit);
            text-decoration: underline;
          }
          .download-code-link13 {
            margin-left: var(--dl-space-space-unit);
            text-decoration: underline;
          }
          .download-code-link14 {
            margin-left: var(--dl-space-space-unit);
            text-decoration: underline;
          }
