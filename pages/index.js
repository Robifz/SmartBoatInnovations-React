          ...
          <div className="landing-page-container2">
            ...
            >
              ...
              >
                ...
                >
                  <Link href="/">
                    <a className="landing-page-link">Home</a>
                  </Link>
                  <Link href="/about">
                    <a className="landing-page-link01">About</a>
                  </Link>
                  <Link href="/services">
                    <a className="landing-page-link02">Services</a>
                  </Link>
                  <span className="landing-page-text">Code</span>
                  <Link href="/contact">
                    <a className="landing-page-link03">Contact</a>
                  </Link>
                </nav>
              </div>
              <div
              ...
              >
                ...
                >
                  ...
                  >
                    <Link href="/">
                      <a className="landing-page-link04">Home</a>
                    </Link>
                    <Link href="/about">
                      <a className="landing-page-link05">About</a>
                    </Link>
                    <Link href="/services">
                      <a className="landing-page-link06">Services</a>
                    </Link>
                    <Link href="/download-code">
                      <a className="landing-page-link07">Code</a>
                    </Link>
                    <Link href="/contact">
                      <a className="landing-page-link08">Contact</a>
                    </Link>
                  </nav>
        ...
        <footer className="landing-page-footer">
          <div className="landing-page-container6">
            <nav className="landing-page-nav3">
              <Link href="/">
                <a className="landing-page-link15">Home</a>
              </Link>
              <Link href="/about">
                <a className="landing-page-link16">About</a>
              </Link>
              <Link href="/services">
                <a className="landing-page-link17">Services</a>
              </Link>
              <Link href="/download-code">
                <a className="landing-page-link18">Code</a>
              </Link>
              <Link href="/contact">
                <a className="landing-page-link19">Contact</a>
              </Link>
            </nav>
          </div>
