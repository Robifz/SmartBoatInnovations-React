...
@Component({
  selector: 'download-code',
  templateUrl: 'download-code.component.html',
  styleUrls: ['download-code.component.css'],
})
export class DownloadCode {
  raw0vqn: string = ' '
  constructor(private title: Title, private meta: Meta) {
    this.title.setTitle('Download-Code - SmartBoatInnovations')
    this.meta.addTags([
      {
        name: 'description',
        content:
