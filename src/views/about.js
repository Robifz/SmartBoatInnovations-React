          ...
          <header data-thq="thq-navbar" className="about-navbar-interactive">
            ...
            >
              ...
              >
                ...
                <Link to="/about" className="about-navlink01">
                  About
                </Link>
                <Link to="/services" className="about-navlink02">
                  Services
                </Link>
                <Link to="/download-code" className="about-navlink03">
                  Code
                </Link>
                <Link to="/contact" className="about-navlink04">
                  Contact
                </Link>
              </nav>
            </div>
            ...
            <div data-thq="thq-mobile-menu" className="about-mobile-menu">
              ...
              >
                ...
                >
                  ...
                  <Link to="/about" className="about-navlink06">
                    About
                  </Link>
                  <Link to="/services" className="about-navlink07">
                    Services
                  </Link>
                  <Link to="/download-code" className="about-navlink08">
                    Code
                  </Link>
                  <Link to="/contact" className="about-navlink09">
                    Contact
                  </Link>
                </nav>
      ...
      <footer className="about-footer">
        <div className="about-container6">
          <nav className="about-nav3">
            ...
            <Link to="/about" className="about-navlink11">
              About
            </Link>
            <Link to="/services" className="about-navlink12">
              Services
            </Link>
            <Link to="/download-code" className="about-navlink13">
              Code
            </Link>
            <Link to="/contact" className="about-navlink14">
              Contact
            </Link>
          </nav>
        </div>
