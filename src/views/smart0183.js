...
import './smart0183.css'

const Smart0183 = (props) => {
  return (
    <div className="smart0183-container">
      <Helmet>
        <title>Smart0183 - SmartBoatInnovations</title>
        <meta
          name="description"
        ...
        />
        <meta property="og:title" content="Smart0183 - SmartBoatInnovations" />
        <meta
      ...
      <div className="smart0183-container01">
        <div className="smart0183-container02">
          <header
            data-thq="thq-navbar"
            className="smart0183-navbar-interactive"
          >
            <div
              data-thq="thq-navbar-nav"
              data-role="Nav"
              className="smart0183-desktop-menu"
            >
              <nav
                data-thq="thq-navbar-nav-links"
                data-role="Nav"
                className="smart0183-nav"
              >
                <Link to="/" className="smart0183-navlink">
                  Home
                </Link>
                <Link to="/equipment" className="smart0183-navlink01">
                  Equipment
                </Link>
                <Link to="/services" className="smart0183-navlink02">
                  Services
                </Link>
                <Link to="/download-code" className="smart0183-navlink03">
                  Code
                </Link>
                <Link to="/contact" className="smart0183-navlink04">
                  Contact
                </Link>
              </nav>
            </div>
            <div
              ...
              className="smart0183-btn-group"
            ></div>
            <div data-thq="thq-burger-menu" className="smart0183-burger-menu">
              <svg viewBox="0 0 1024 1024" className="smart0183-icon">
                <path d="M128 554.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 298.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 810.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"></path>
              </svg>
            </div>
            <div data-thq="thq-mobile-menu" className="smart0183-mobile-menu">
              <div
                data-thq="thq-mobile-menu-nav"
                data-role="Nav"
                className="smart0183-nav1"
              >
                <div className="smart0183-container03">
                  <div
                    data-thq="thq-close-menu"
                    className="smart0183-menu-close"
                  ></div>
                </div>
                <nav
                  data-thq="thq-mobile-menu-nav-links"
                  data-role="Nav"
                  className="smart0183-nav2"
                >
                  <Link to="/" className="smart0183-navlink05">
                    Home
                  </Link>
                  <Link to="/equipment" className="smart0183-navlink06">
                    Equipment
                  </Link>
                  <Link to="/services" className="smart0183-navlink07">
                    Services
                  </Link>
                  <Link to="/download-code" className="smart0183-navlink08">
                    Code
                  </Link>
                  <Link to="/contact" className="smart0183-navlink09">
                    Contact
                  </Link>
                </nav>
                <div className="smart0183-container04"></div>
              </div>
              <div className="smart0183-icon-group">
                <svg
                  viewBox="0 0 950.8571428571428 1024"
                  className="smart0183-icon2"
                >
        ...
        <img alt="image" src="/wlan%20logo.png" className="smart0183-image" />
        <div className="smart0183-container05">
          <span className="smart0183-text">Smart Boat Innovations</span>
        </div>
      </div>
      ...
      <div className="smart0183-container07">
        <div className="smart0183-container08">
          <div className="smart0183-container09">
            <Script
    ...
    <div style="position: absolute; top: 10px; right: 10px;">
        ...
        <a href="/smart0183.txt" download style="padding: 5px 10px; background-color: #28a745; color: #fff; border: none; border-radius: 4px; text-decoration: none; text-align: center; line-height: 1.5;">Download</a>
    </div>
...
`}
      ...
      <footer className="smart0183-footer">
        <div className="smart0183-container10">
          <nav className="smart0183-nav3">
            <Link to="/" className="smart0183-navlink10">
              Home
            </Link>
            <Link to="/equipment" className="smart0183-navlink11">
              Equipment
            </Link>
            <Link to="/services" className="smart0183-navlink12">
              Services
            </Link>
            <Link to="/download-code" className="smart0183-navlink13">
              Code
            </Link>
            <Link to="/contact" className="smart0183-navlink14">
              Contact
            </Link>
          </nav>
        </div>
